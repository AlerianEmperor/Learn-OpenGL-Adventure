...
int main()
{
	...
	float boderColor[] = { 1.0f, 1.0f, 1.0f };
	...
	//simpleDepthShader.setFloat("near_plane", 1.0f);
	//simpleDepthShader.setFloat("far_plane", 7.5f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//lightPos.x += sinf(glfwGetTime()) * 0.2;
		//lightPos.z += cosf(glfwGetTime()) * 0.2;

		mat4 lightProjection = ortho(-10.0f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
		//mat4 lightProjection = perspective(40.0f, 1.0f, near_plane, far_plane);//ortho(-10.0f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
